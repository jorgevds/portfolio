        ...
        <Mermaid>
            <Layout>
                <article className="p-4 minlg:p-12 minlg:w-largeClamp minlg:m-auto ">
                    <BlogHeader title={post.title} coverImage={post.coverImage} date={post.date} />
                    <section className="markdown" dangerouslySetInnerHTML={{ __html: post.content }}></section>
...
export async function getStaticProps({ params }: Params) {
    const post = getPostBySlug(params.slug, ['title', 'date', 'content', 'coverImage']);
