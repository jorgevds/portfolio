...
const Contact: React.FC<ContactProps> = () => {
    return (
        <article className="my-20 text-center min-h-md md:mx-4" id="contact">
            ...
            <h2 className="mb-4 text-lg" data-aos="fade-up" data-aos-once="true" data-aos-delay="300">
                But I'm always interested in opportunities to work together
            </h2>
            <h3 className="text-xl" data-aos="fade-up" data-aos-once="true" data-aos-delay="600">
